...
WS.callTeam = {
    enabled = true,
    coords = vector3(-1085.7135, -2833.2366, 27.7087),
    cooldown = 30 -- in seconds
}

WS.positions = {
    ["admin_inside"] = vector4(-1106.7208, -2812.0964, 27.7088, 148.5103),
    ["airport_middle"] = vector3(-1081.7200, -2821.6394, 27.4656),
    ["airport_outside"] = vector4(-1037.9657, -2738.0217, 20.1693, 325.7212),
    ["airport_spawns"] = {
        vector4(-1139.3312, -2806.9009, 27.7087, 256.0582),
        vector4(-1142.5334, -2793.9797, 27.7088, 252.6913),
        vector4(-1140.4073, -2787.5847, 27.7088, 179.0439),
        vector4(-1136.6349, -2798.2600, 27.7087, 196.1697),
        vector4(-1134.2577, -2806.8691, 27.7087, 197.7602),
    }
}
