...
--[[
    Available options:
    - CLOTHING_TO_USE = "framework" --(esx_skin in ESX and qb-clothing in QBCore)
    - CLOTHING_TO_USE = "illenium" --(illenium-appereance for both ESX and QBCore)
]]
CLOTHING_TO_USE = "framework"
