...
RegisterCommand('unequip', function(source, args, rawCommand)
    TriggerServerEvent('greenwood_attachments:unequip', GetWeaponFromHash(GetSelectedPedWeapon(PlayerPedId())).name)
end, false)

RegisterKeyMapping('unequip', 'Waffenteile abnehmen', 'keyboard', 'z')

RegisterNetEvent('greenwood_attachments:getCurrentWeapon', function()
    TriggerServerEvent('greenwood_attachments:returnWeapon', GetWeaponFromHash(GetSelectedPedWeapon(PlayerPedId())).name)
end)
