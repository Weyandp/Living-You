Locales['cs'] = {
    ...
    ['day_friday'] = 'Pátek',
    ['radiojoined'] = 'Vstoupili jste do rádia %s',
    ['fixphone'] = 'Pokud tato zpráva nezmizí během několika sekund, napište /fixphone.',
    ['message_app_new_message'] = 'Nová zpráva od %s',
    ...
    ['valet_car_delivered_2'] = " má své auto doručeno za %s $",
    ['messages_app_newgroup_name'] = "Nová skupina",
    ["command_required_information"] = "Nenapsali jste požadované informace",
    ['twitter_verify'] = "Ověřili jste hráče",
    ['twitter_remove_verify'] = "Hráč již není ověřen",
    ['instagram_verify'] = "Ověřili jste hráče",
    ['instagram_remove_verify'] = "Hráč již není ověřen",
    ...
    ['bank_money_transaction'] = "Peníze byly odeslány %s.",
    ['control_center_already_in_use'] = "Toto číslo je již používáno!",
    ['control_center_leave'] = "Opustili jste kontrolní centrum pro %s!",
    ['control_center_take_control'] = "Stiskněte E, abyste převzali kontrolu nad kontrolním centrem pro %s.",
    ['control_center_taken_control'] = "Převzali jste kontrolu nad kontrolním centrem pro %s!",
    ['control_center_cannot_leave'] = "V současné době nemůžete opustit kontrolní centrum.",
    ['voice_memos_default_name'] = "New recording",
    ['messages_groupchat_added'] = "Byli jste přidáni do skupinového chatu %s."
  }